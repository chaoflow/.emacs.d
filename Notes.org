...
C-h k Middle-mouse-click tells me that the function run on middle
mouse click is mouse-yank-primary, which inserts at point if the
variable mouse-yank-at-point is non-nil.
