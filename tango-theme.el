...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'tango
   `(default ((,class (:foreground ,alum-6 :background ,alum-0))))
   ...
   `(gnus-header-name ((,class (:foreground ,blue-4))))
   `(gnus-header-newsgroups ((,class (:foreground ,alum-4))))
   ;; Message faces
   `(message-header-name ((,class (:foreground ,blue-4))))
  ...
  (custom-theme-set-variables
   'tango
   `(ansi-color-names-vector [,alum-7 ,red-3 ,cham-3 ,butter-3
